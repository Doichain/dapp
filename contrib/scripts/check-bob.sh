...
curl --user admin:generated-password --data-binary '{"jsonrpc": "1.0", "id":"bob-getblockchaininfo-external", "method": "getblockchaininfo", "params": [] }' -H 'content-type: text/plain;' http://$MY_IP:18544/