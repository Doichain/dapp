                        ...
                        echo "start alice node";
                         //agent {
                          ...
                          // sh 'doichain-cli -getinfo'
                           sh 'docker run -td -e REGTEST=true -p 18443:18443  doichain/node-only --hostname=alice'
                           sh 'sleep 10'
                           sh 'doichain-cli -getinfo'
                    ...
                    "bob" : {
                      echo "start bob node";
                       // docker.image("doichain/node-only").withRun("-u root:root") { c ->
                            ...
                            sh 'docker run -td -e REGTEST=true -p 18444:18444 doichain/node-only --hostname=bob'
